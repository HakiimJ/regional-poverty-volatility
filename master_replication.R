# ==============================================================================
# Master Replication Suite: High-Collinearity Small-Sample Model Analysis
# Aligned to Sains Malaysiana Journal Specifications & Formatting Guidelines
# ==============================================================================
# Execution Note: Running the complete MCMC engine chains and full combinatorial 
# simulation design matrix (3 Scenarios x 2 Dimensions x 3 Correlations x 4 Sizes 
# x 500 Replications = 36,000 runs) requires significant computational time. 
# You can scale down `n_reps` below for rapid testing.
# ==============================================================================
